  ...
  const handleSubmit = async (e) => {
    ...
    if (data.image) {
      ...
      try {
        ...
        data.image = filename; // You might need to set this to the Firebase URL
        data.firebaseImageUrl = imgUpload.data.imageUrl;


        // console.log("FIREBASE IMAGE URL");
    ...
    try {
      ...
      if (error.response) {
        ...
        // console.log(data.propertyadder);
        toast.error(`Failed to add Property: ${error.response.data.message} ${data.propertyadder} `);
      } else {
